...
void RosThread::UASS_SetKB_CB(std_msgs::Empty nope)
{
 gui->setControlSource(CONTROL_KB);
}

void RosThread::UASS_SetAI_CB(std_msgs::Empty nope)
{
...
void RosThread::run()
{
    ...
    UASS_SetKB = nh_.subscribe(nh_.resolveName("UASS_SetKB"),10, &RosThread::UASS_SetKB_CB, this);
    UASS_SetAI = nh_.subscribe(nh_.resolveName("UASS_SetAI"),10, &RosThread::UASS_SetAI_CB, this);
